        ...
        <div className='bg-white border space-y-10 rounded shadow-sm px-24 py-12 w-2/3 mx-auto '>
          <form className='space-y-6' onSubmit={handleSubmit(handleUpdateProfile)}>
            <div className='space-y-2'>
              ...
              <input type="text" id='full_name' className='py-2 px-3 bg-gray-100 w-full rounded outline-none border text-gray-500 focus:text-gray-900 tracking-wider' {...register("full_name")} disabled={isSubmitting} aria-disabled={isSubmitting} />
            </div>

            <div className='space-y-2'>
              <label htmlFor="email" className='text-lg'>Email</label>
              <input type="email" id='email' className='py-2 px-3 bg-gray-100 w-full rounded outline-none border text-gray-500 focus:text-gray-900 tracking-wider' {...register("email")} disabled={isSubmitting} aria-disabled={isSubmitting} />
            ...
            <div className='space-y-2'>
              ...
              <input type="password" id='password' className='py-2 px-3 bg-gray-100 w-full rounded outline-none border text-gray-500 focus:text-gray-900 tracking-wider' {...register("password")} disabled={isSubmitting} aria-disabled={isSubmitting} />
            ...
            <div className='space-y-2'>
              ...
              <input type="address" id='address' className='py-2 px-3 bg-gray-100 w-full rounded outline-none border text-gray-500 focus:text-gray-900 tracking-wider' {...register("address")} disabled={isSubmitting} aria-disabled={isSubmitting} />
            ...
            <div className='space-y-2'>
              ...
              <input type="text" id='phone_number' className='py-2 px-3 bg-gray-100 w-full rounded outline-none border text-gray-500 focus:text-gray-900 tracking-wider' {...register("phone_number")} disabled={isSubmitting} aria-disabled={isSubmitting} />
            ...
            <div className='space-y-2'>
              ...
              <input type="file" id='profile_picture' className='py-2 px-3 bg-gray-100 w-full rounded outline-none border text-gray-500 focus:text-gray-900 tracking-wider' {...register("profile_picture")} disabled={isSubmitting} aria-disabled={isSubmitting} />
